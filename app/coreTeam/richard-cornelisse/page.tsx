            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Richard Cornelisse <br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/sapaddonforvat/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BMa16ZppkRoaPnTh%2Fi9%2FNJw%3D%3D" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Richard is the founder and CEO of KGT and a former EY Indirect Tax Partner with over 30 years of experience. He created one of the
                            first indirect tax business units at a Big Four firm, with a focus on indirect tax and SAP. An expert in Tax Control Frameworks, he
                            exclusively publishes on the Global Indirect Tax Management website to share best practices.
                        </span>
                    </div>
                </div>
            </div>
