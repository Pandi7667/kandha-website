            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Cynthia Morgan <br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/cynthia-morgan-298713a/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Cynthia J. Morgan is a multi-award-winning transformation leader specializing in Artificial Intelligence (AI), project
                            management, and organizational change management. She is recognized for leading complex digital, ERP, Agile, and
                            business transformation efforts across global organizations, with a strong ability to align strategy, people, processes,
                            and technology.
                        </span>
                        <span>
                            From planning through implementation, she drives business readiness, training, communications, and long-term
                            adoption. Cynthia has delivered large-scale initiatives that enhance operational performance, ease resistance, and
                            speed value realization. Her expertise is further strengthened by extensive training in AI for Business, Agile
                            methodologies, and project management, enabling her to help organizations adopt emerging technologies and lead
                            change with clarity, discipline, and impact.
                        </span>
                    </div>
                </div>
            </div>
