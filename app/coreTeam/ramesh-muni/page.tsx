            ...
            <div className="md:flex pt-5 p-16">
                ...
                <div className="absolute mobile" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            ...
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/ramesh-muni-5210349/" target="_blank" >
                                <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                        Ramesh is the CTO at KGT and a highly experienced SAP Technology Consultant with over 25 years of experience delivering 
complex, enterprise-scale SAP solutions. He specializes in tax technology, SAP transformations, and SAP DRC, helping organizations 
translate complex global tax regulations into scalable, future-ready SAP solutions.
                        </span>
                    </div>
                </div>
            </div>
