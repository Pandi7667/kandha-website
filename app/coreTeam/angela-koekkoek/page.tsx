            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Angela Koekkoek <br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/angela-koekkoek-7665724/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Angela is an Indirect Tax and Tax Function Effectiveness Specialist with over 20 years of experience in direct and
                            indirect taxation within Big 4 and corporate environments, including roles as Global Indirect Tax Lead. She
                            specializes in indirect tax governance, VAT control frameworks, and translating regulatory, business model, and
                            M&A changes into SAP tax design.
                        </span>
                    </div>
                </div>
            </div>
