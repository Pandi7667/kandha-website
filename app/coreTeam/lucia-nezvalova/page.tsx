            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Lucia Nezvalova <br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/lucia-nezvalova-30168ab1/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Lucia is the COO and Head of R&D at KGT. With over 20 years of experience in tax advisory for complex SAP environments, she
                            previously led Mondelez International`s Centre of Excellence for VAT compliance. Her expertise includes aligning tax requirements
                            with business processes, designing sustainable SAP tax solutions, and implementing global regulatory mandates. She specializes in
                            SAP transformations, tax determination logic, and future-proof tax technology strategies.
                        </span>
                    </div>
                </div>
            </div>
