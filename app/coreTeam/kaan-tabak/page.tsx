            ...
            <div className="md:flex pt-5 p-16">
                ...
                <div className="absolute mobile" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            ...
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/kaan-tabak-93b04a96/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Kaan is the Senior ABAP Developer & Lead Product Architect at KGT and has over 10 years of experience in SAP development and 
compliance-focused solution design. He combines strong ABAP expertise with in-depth knowledge of e-invoicing and statutory 
reporting to deliver efficient, scalable SAP solutions that support complex business and regulatory requirements.
                        </span>
                    </div>
                </div>
            </div>
