            ...
            <div className="md:flex pt-5 p-16">
                ...
                <div className="absolute mobile" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            ...
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/brianolah/" target="_blank" >
                                <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                        An experienced and forward-thinking independent board director and 
                        C-Suite executive - widely sought out for innovation with all facets of disruptive 
                        technologies with businesses ranging from startups to Fortune 500s. A highly 
                        regarded boardroom leader in strategy and market creation. An entrepreneur with 
                        an agile mindset renowned for building and leading diverse technologies to extraordinary 
                        returns. Member of the American College of Corporate Directors and frequent 
                        business growth and development speaker.
                        </span>
                    </div>
                </div>
            </div>
