            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Maja Ciarkowska<br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/majaciarkowska/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Maja is an Indirect Tax, Tax Technology & Accounting Expert with over 20 years of experience in indirect tax and
                            accounting within multinational corporations. She specializes in SAP VAT data analysis, data-driven pre-audit reviews,
                            and SAP-based VAT compliance and reporting, including e-invoicing and SAF-T. Her expertise also includes migrating
                            accounting and tax processes SSCs and Centers of Excellence (CoEs).
                        </span>
                    </div>
                </div>
            </div>
