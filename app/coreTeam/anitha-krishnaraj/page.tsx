            ...
            <div className="md:flex pt-5 p-16">
                    ...
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            <span className="font-semibold text-2xl md:pl-20">
                                Anitha Krishnaraj <br></br>
                            </span>
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/luisrangelpm//" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Luis is a bilingual (English/Spanish) Senior Project Manager and U.S. Army Veteran with extensive experience leading complex IT, 
operations, and supply chain transformation initiatives across enterprise environments. PMP-certified and holding a Master of 
Science in Leadership and Management, he specializes in project delivery, enterprise application integrations, ERP 
implementations, mergers and acquisitions, operational process improvement, and cross-functional business transformation.
                        </span>
                        <span>
                            Luis is known for driving collaboration across technical and business teams, building strong stakeholder relationships, and 
delivering strategic solutions that align technology, operations, and supply chain objectives with overall business goals while 
maintaining a strong focus on execution, leadership, and organizational success.
                        </span>
                    </div>
                </div>
            </div>
