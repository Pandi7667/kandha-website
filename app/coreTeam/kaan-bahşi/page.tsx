            ...
            <div className="md:flex pt-5 p-16">
                ...
                <div className="absolute mobile" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about inline-flex md:mt-0 mt-10 border-[#a28874] 
                        ...
                        <span className="inline-flex justify-between whitespace-nowrap">
                            ...
                            <div className="pl-10">
                                <a href="https://www.linkedin.com/in/kaanbahsi/" target="_blank" >
                                    <svg
                ...
                <div className='md:flex md:justify-between md:absolute relative md:w-[86%] md:mt-28 
                    ...
                    <div className='md:w-1/2'>
                        <span className=''>
                            Kaan is the CIO at KGT, with over 15 years of hands-on ABAP and e-invoicing experience in complex SAP environments. He focuses
                            on high-volume invoice processing, compliance-driven solution design, performance optimization, and scalable SAP architectures.
                            Kaan builds robust, future-ready technical landscapes that align regulatory requirements with reliable and high-performing SAP
                            systems.
                        </span>
                    </div>
                </div>
