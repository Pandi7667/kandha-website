...
import cf02 from "../../assets/Case Study 03a.png";
import cf03 from "../../assets/Case Study 03.png";
...
import cs_003 from "../../assets/cs_003.png";
import cs_0031 from "../../assets/cs_0031.png";
        ...
        <div style={{ overflowX: 'hidden' }}>
            ...
            <div className="md:flex md:w-[90%] md:mt-10">
                <div className="md:hidden block mb-10" style={{ flex: '1', zIndex: "99999", }}>
                    <Image src={cf02} alt="" className="w-full h-[120px] object-cover" />
                </div>
                <div className="md:absolute relative" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about-case border-[#7b5133] 
                        ...
                        <span className="md:inline-flex text-justify p-5">
                            <span className="font-semibold flex justify-start pl-5 md:text-2xl">                           
                                Employee Learning Journey Enhancement <br />
                            </span>
                        </span>
                    </div>
                    <div className='p-10 rounded-2xl mt-5 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            ...
                            A theme park sought to modernize employee learning for onboarding and 
                            skill development, aiming to reduce training costs while enhancing effectiveness.
                            </span>
                        </span>
                    </div>
                    <div className='p-10 rounded-2xl mt-5 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Solution <br/>
                            <span className='flex pt-2 md:text-justify text-left'>                            
                                Design workshops defined a learning vision and ecosystem, incorporating 
                                chunked digital content, adaptive curriculum, and blended delivery for 
                    ...
                    <div className='p-10 rounded-2xl mt-5 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Results <br/>
                            <span className='flex pt-2 md:text-justify text-left'>
                            Motivated employees engaged in collaborative learning processes, 
                            benefiting from digitized content and personalized presentations, 
                            reducing reinforcement time and fostering collaboration.
                            </span>
                ...
                <div className="md:hidden block mt-10 flex justify-center items-center" style={{ flex: '1', zIndex: "99999" }}>
                    <Image src={cf03} alt="" className="w-full h-[100px] object-cover" />
                </div>

                <div className="hidden md:inline-block md:-mr-80 md:ml-60 gap-y-10" style={{ flex: '1', zIndex: "99999" }}>
                    <Image src={cf02} alt="" className="w-80 h-100 mb-10" />
