...
import cf02 from "../../assets/Case Study 05 a.png";
import cf03 from "../../assets/Case Study 05.png";
...
import cs_005 from "../../assets/cs_005.png";
import cs_0051 from "../../assets/cs_0051.png";
        ...
        <div style={{ overflowX: 'hidden' }}>
            ...
            <div className="md:flex md:w-[90%] md:mt-10">
                <div className="md:hidden block mb-10" style={{ flex: '1', zIndex: "99999", }}>
                    <Image src={cs_005} alt="" className="w-full h-full object-cover" />
                </div>
                <div className="md:absolute relative" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about-case border-[#7b5133] 
                       ...
                       <span className="md:inline-flex p-5">
                            <span className="font-semibold flex justify-start pl-5 md:text-2xl">
                                AI Mobile-first Communication Hub<br />
                            </span>
                        </span>
                    </div>
                    <div className='p-10 rounded-2xl mt-8 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            ...
                            <span className='flex pt-2 md:text-justify text-left'>
                                A midwestern hospital group faced high turnover due to confusion
                                accessing job information through intranet resources.
                            </span>
                        </span>
                    </div>
                    <div className='p-10 rounded-2xl mt-8 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Solution <br />
                            <span className='flex pt-2 md:text-justify text-left'>
                                Created a mobile chatbot providing automated access to key information
                                and real-time connections via Microsoft Teams, integrated into the onboarding process.
                            </span>
                    ...
                    <div className='p-10 rounded-2xl mt-10 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Results <br />
                            <span className='flex pt-2 md:text-justify text-left'>
                                Reduced time to answer key questions from hours to seconds,
                                improved employee connections, and decreased regrettable turnover.
                            </span>
