...
import cf02 from "../../assets/Case Study 06 a.png";
import cf03 from "../../assets/Case Study 06.png";
...
import cs_006 from "../../assets/cs_006.png";
import cs_0061 from "../../assets/cs_0061.png";
        ...
        <div style={{ overflowX: 'hidden' }}>
            ...
            <div className="md:flex md:w-[90%] md:mt-10">
                <div className="md:hidden block mb-10" style={{ flex: '1', zIndex: "99999", }}>
                    <Image src={cs_006} alt="" className="w-full object-cover" />
                </div>
                <div className="md:absolute relative" style={{ flex: '1', position: 'relative' }}>
                    <div className="border-about-case border-[#7b5133] 
                        ...
                        <span className="md:inline-flex p-5">
                            <span className="font-semibold flex justify-start pl-5 md:text-2xl">
                                Supercharging micro-learning<br />
                            </span>
                        </span>
                    </div>
                    ...
                    <div className='p-10 rounded-2xl mt-8 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            ...
                            <span className='flex pt-2 md:text-justify text-left'>
                                A global insurance organization needed to onboard new HR staff
                                and transition existing staff to a new operating model.</span>
                        </span>
                    </div>
                    ...
                    <div className='p-10 rounded-2xl mt-8 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Solution <br />
                            <span className='flex pt-2 md:text-justify text-left'>
                                Implemented a change management strategy with online communities
                                and micro-learning assets on Microsoft Yammer.
                            </span>
                        </span>
                    </div>
                    ...
                    <div className='p-10 rounded-2xl mt-8 md:ml-24 ml-10 md:-mr-44 bg-[#eeeeee] 
                        ...
                        <span className='ml-5'>
                            Results <br />
                            <span className='flex pt-2 md:text-justify text-left'>
                                Accelerated onboarding through video-based micro-learning, resolving issues
                                and aligning staff to the new operating model effectively and efficiently.  </span>
                ...
                <div className="md:hidden block mt-10 flex justify-center items-center" style={{ flex: '1', zIndex: "99999" }}>
                    <Image src={cs_0061} alt="" className="w-full object-cover" />
                </div>

                <div className="hidden md:inline-block md:-mr-80 md:ml-60 gap-y-10" style={{ flex: '1', zIndex: "99999" }}>
                    <Image src={cf02} alt="" className="w-80 h-100 mb-6" />
